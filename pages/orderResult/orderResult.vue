	...
	<view class="container">
		...
		<view class="tui-content">
			<view class="tui-form">
				...
				<view class="tui-btn-box">
					<tui-button type="danger" width="240rpx" height="70rpx" :size="28" plain shape="circle" @click="go(1)">返回商品列表</tui-button>
		...
		<view class="tui-tips">
			...
			<view class="tui-light-grey">
				付款成功后，我司不会以付款异常、卡单、系统升级为由联系您。请勿泄露银行卡号、手机验证码，否则会造成钱款损失！谨防电话诈骗！
			</view>
		</view>
	</view>
</template>
